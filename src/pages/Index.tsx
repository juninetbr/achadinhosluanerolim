...
const Index = () => {
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 flex items-center h-full px-20 md:px-24 lg:px-28">
        <div className="max-w-[500px]">
          <h1
            className="text-foreground font-bold leading-[1.1] mb-6"
            style={{ fontSize: "clamp(30px, 4.5vw, 56px)" }}
          >
            Os achados pra casa que fazem sentido, num só lugar
          </h1>

          <p className="text-muted-foreground text-lg leading-[1.5] mb-8 max-w-[460px]">
